...
<h2>Thêm Mới Dữ Liệu</h2>
    <form method="POST" action="../AdminPermissionsController/add">
        <div>
        ...
        <div>
            <input type="text" name="http_path" placeholder="Nhập http_path" >
        </div>
        <div>
        ...
        <div >
            <textarea name="http_method" placeholder="Nhập http_method" class="permission"></textarea>
        </div>
        <div>
