...
<h2>Thêm Mới Dữ Liệu</h2>
    <form method="POST" action="../update">
        ...
        <div class="form-group">
            ...
            <input type="date" name="birthday" class="form-control" value="<?php echo $row1['birthday']?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="linkfb" class="form-control" value="<?php echo $row1['linkfb']?>">
        </div>
        <div class=form-group>
