...
<h2>Thêm Mới Dữ Liệu</h2>
    <form method="POST" action="../update">
        ...
        <div class="form-group">
            <label for="">Number session : </label>
            <input type="text" name="number_session" class="form-control" value="<?php echo $row1['number_session']?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="promotion_price" class="form-control" value="<?php echo $row1['promotion_price']?>">
        </div>
        <div class="form-group">
            <label for="">Is free : </label>
            <input type="text" name="is_free" class="form-control" value="<?php echo $row1['is_free']?>">
        </div>
        <div class="form-group">
